...
# 
# make_heatmap_rna <- function(df0, env, trt_group, paramcd_f, atpt_f, sex_f, aval_range = c(0, 9999), add_aval_txt = FALSE) {
...
#   env$rna$tdata_filtered <- df_filtered
#   env$rna$df_filtered_pivoted <- df_filtered_pivoted
#   env$rna$row_index <- seq_len(nrow(df_filtered_pivoted))
#   env$rna$col_index <- seq_len(ncol(df_filtered_pivoted))
#   
#   ht = create_heatmap2(
#     df_filtered_pivoted,
#     df0,
